...
if __name__ == "__main__":
    ...
    case_2_not_acceptable = (
        "An unacceptable integer was entered. Please Enter acceptable integer."
    )
    ...
    if len(listit) > 1:
        ...
        chosen_book = excel_files[
            int(sanitize_integer_input(unsanitary_chosen_book, len(excel_files))) - 1
        ]
    else:
        chosen_book = (
